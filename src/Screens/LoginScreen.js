...
function LoginScreen() {
    return (
        <div className='min-h-screen bg-gray-100 text-gray-900 flex justify-center'>
            <div className='max-w-screen-xl m-0 sm:m-20 bg-white shadow-2xl sm:rounded-lg flex justify-center flex-1'>
            <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                <div><h1 className=' text-center font-black text-2xl text-blue-500'>Kleen </h1>
                </div>
                <div className="mt-12 flex flex-col items-center">
                <h1 className="text-2xl xl:text-3xl font-extrabold">Sign up for Kleen</h1>
            ...
            <div className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium my-12 bg-white transform translate-y-1/2">
    ...
    <div className=' hidden lg:block w-full'>
        <img src={Hacker} className=' h-4/5 w-4/5 mx-auto items-center rounded-r-xl' alt='' />
    </div>
          </div>        
